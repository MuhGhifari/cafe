...
<div class="d-flex" id="wrapper">
    ...
    <div class="col-md-10">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post"  action=" {{route('admin.productupdate', ['id' => $products->id])}}">	
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="{{ $products->email}}" >
                            </div>

                        <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" name="username" id="username" class="form-control" value="{{ $products->username }}" >
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control" value="{{ $products->password }}">
                            </div>
